...
import { Star, CheckCircle, User, BookOpen, Award, TrendingUp } from "lucide-react";
import { CustomButton, ButtonColor, CustomLinkButton } from "@/components/shared/CustomButton";
                ...
                <div className="grid gap-12 lg:grid-cols-2 lg:gap-8 items-center">
                    ...
                    <div className="flex flex-col justify-center">
                        ...
                        <div className="mt-12 grid grid-cols-3 gap-8">
                            <div>
                                <div className="text-4xl font-medium text-[rgb(99,102,241)]">{activeLearnerCount}</div>
                                <p className="text-xl text-gray-600 dark:text-gray-400">Active Learners</p>
                            </div>
                            <div>
                                <div className="text-4xl font-medium text-[rgb(99,102,241)]">{expertInstructorCount}</div>
                                <p className="text-xl text-gray-600 dark:text-gray-400">Expert Instructors</p>
                            </div>
                            <div>
                                <div className="text-4xl font-medium text-[rgb(99,102,241)]">{onlineCoursesCount}</div>
                                <p className="text-xl text-gray-600 dark:text-gray-400">Online Courses</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="absolute -bottom-6 left-25 -translate-x-1/2 rounded-2xl bg-white px-6 py-4 shadow-xl max-w-xs">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-2xl font-medium text-gray-900">{issueCount} Issued</p>
                                </div>
                            </div>
                        </div>
                    </div>
