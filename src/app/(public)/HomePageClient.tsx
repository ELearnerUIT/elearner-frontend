...
import type { BannerSlide as BannerSlideType } from "@/core/components/public/landingpage/BannerCarousel";
...
export default function HomePageClient({ slides }: { slides: BannerSlideType[] }) {
