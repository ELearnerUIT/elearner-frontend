        ...
        <section className="w-full mt-6 px-4 sm:px-6 md:px-10 xl:px-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 md:gap-10 lg:gap-12 items-start">
                ...
                >
                    ...
                    >
                        Expand your skills, master new knowledge, and grow with
                        thousands of high-quality courses — from programming and
                        design to AI and leadership.
                    </motion.p>
                    ...
                    >
                        Learn anytime, anywhere, with personalized paths and
