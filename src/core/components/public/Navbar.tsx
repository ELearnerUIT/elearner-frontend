            ...
            <div className="container mx-auto px-4 h-16 flex items-center justify-between gap-4 text-body">
                ...
                <div className="flex-1 max-w-[960px]">
                    <div className="searchbar">
                        <Search
                            className="absolute left-4 top-1/2 -translate-y-1/2 input-icon"
                            size={18}
                        />
                        <input
                ...
                <div className="flex items-center gap-2 flex-shrink-0">
                    ...
                    {!isLoggedIn ? (
                        <>
                            ...
                            <Link href="/signup">
                                <button className="btn btn-primary neon">
                                    Sign up
                                </button>
                            </Link>
                        </>
            ...
            >
                ...
                >
                    ...
                    <div className="mt-auto flex gap-2">
                        <button className="btn btn-outline strong flex-1">
                            Log in
                        </button>
                        <button className="btn btn-primary neon flex-1">
                            Sign up
                        </button>
                    </div>
                </div>
