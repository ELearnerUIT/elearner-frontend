...
export const TeacherSidebar = memo(
    ({ isCollapsed, onToggle, isMobileOpen, onMobileClose }: SidebarProps) => {
        ...
        const SidebarContent = ({
            ...
            <div className="flex flex-col h-full">
                ...
                <div className="h-16 flex items-center justify-center px-4 border-b border-slate-200 dark:border-slate-700/50 bg-white/50 dark:bg-slate-900/50">
                    {isCollapsed && !isMobile ? (
                        ...
                        >
                            ...
                            <div>
                                <span className="text-lg font-extrabold tracking-tight text-[color:var(--brand-primary)]">
                                    ELearner
                                </span>
              ...
              `}
                            >
                                <Icon
                                    className={`w-5 h-5 flex-shrink-0 transition-transform ${active ? "" : "group-hover:scale-110"}`}
                                />
