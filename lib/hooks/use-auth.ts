 ...
 * Refresh token
 */
export function useRefreshToken(options?: UseMutationOptions<RefreshTokenResponse, Error, RefreshTokenRequest>) {
  const queryClient = useQueryClient();
 ...
 */
export function useResendVerification(options?: UseMutationOptions<void, Error, void>) {
  return useMutation({
 ...
 * Forgot password
 */
export function useForgotPassword(options?: UseMutationOptions<void, Error, ForgotPasswordRequest>) {
  return useMutation({
 ...
 * Reset password
 */
export function useResetPassword(options?: UseMutationOptions<void, Error, { token: string; data: ResetPasswordRequest }>) {
  return useMutation({
 ...
 * Change password
 */
export function useChangePassword(options?: UseMutationOptions<void, Error, ChangePasswordRequest>) {
  const queryClient = useQueryClient();
 ...
 * Social login
 */
export function useSocialLogin(options?: UseMutationOptions<LoginResponse, Error, SocialLoginRequest>) {
  const queryClient = useQueryClient();
